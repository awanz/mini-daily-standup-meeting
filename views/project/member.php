    ...
    <div class="card my-2">
        <div class="card-body">
            <h5 class="card-title">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <a href="<?= BASE_URL ?>/project/meeting-attendance/<?= $id ?>" class="btn btn-primary my-2">Absensi</a>
                        <?php if ($isAdmin): ?>
            ...
            <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            ...
                                            <?php if (!empty($value[3])) { ?>
                                                <span id="phoneText"><?= htmlspecialchars($value[3]) ?></span>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="panelsStayOpen-dailyStandupMeetingColls">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseDailyStandupMeetingColls" aria-expanded="false" aria-controls="panelsStayOpen-collapseDailyStandupMeetingColls">
                            <b>Daily Standup Meeting (Hari Ini)</b>
                        </button>
                    </h2>
                    <div id="panelsStayOpen-collapseDailyStandupMeetingColls" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-dailyStandupMeetingColls">
                        <div class="accordion-body">
